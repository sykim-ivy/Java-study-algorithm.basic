...
public class ch1_q3 {
    ...
    static int FindMinValue(int v1, int v2, int v3, int v4) {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("최소값은 " + FindMinValue(inputInt1, inputInt2, inputInt3, inputInt4) + "입니다.");
